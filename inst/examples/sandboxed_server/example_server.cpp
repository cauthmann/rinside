 ...
 *
 * It would be desireable to allow the client to specify the timeout. Unfortunately, only the fork()ed
...
/*
 * Maybe our wrappers need to call a function. It may be smart to capture the function before the fork()
 * and store a reference.
 */
// Rcpp::Function *func_attributes = nullptr;
...
int main()
{
	...
	//Rcpp::Function _attributes("attributes");
	//func_attributes = &_attributes;
